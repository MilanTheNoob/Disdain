...
public class SettingsMenu : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        MainAudioSlider.value = SavingManager.SaveData.SettingsData.MainAudioLevel;
        SFAudioSlider.value = SavingManager.SaveData.SettingsData.SFAudioLevel;
        MusicAudioSlider.value = SavingManager.SaveData.SettingsData.MusicAudioLevel;

        AudioMixer.SetFloat("MainAudioLevel", SavingManager.SaveData.SettingsData.MainAudioLevel);
        AudioMixer.SetFloat("SFLevel", SavingManager.SaveData.SettingsData.SFAudioLevel);
        AudioMixer.SetFloat("MusicLevel", SavingManager.SaveData.SettingsData.MusicAudioLevel);
        ...
        //GameManager.ActiveUI.Sensitivity = SavingManager.SaveData.SettingsData.Sensitivity;
    ...
    public void SetMainVolume(float volume) { AudioMixer.SetFloat("MainAudioLevel", volume); SavingManager.SaveData.SettingsData.MainAudioLevel = volume; }
    public void SetSFVolume(float volume) { AudioMixer.SetFloat("SFLevel", volume); SavingManager.SaveData.SettingsData.SFAudioLevel = volume; }
    public void SetMusicVolume(float volume) { AudioMixer.SetFloat("MusicLevel", volume); SavingManager.SaveData.SettingsData.MusicAudioLevel = volume; }
    ...
    //public void SetSensitivity(float s) { GameManager.Act.Sensitivity = s; SavingManager.SaveData.SettingsData.Sensitivity = s; }
