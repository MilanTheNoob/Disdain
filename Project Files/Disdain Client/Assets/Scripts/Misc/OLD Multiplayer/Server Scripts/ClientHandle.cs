...
public class ClientHandle : MonoBehaviour
{
    public static void Welcome(Packet _packet)
    {
        ...
        if (_packet.ReadBool()) { GPlayManager.instance.EarlyBird(); }
    ...
    public static void SpawnPlayer(Packet _packet)
    {
        ...
        MultiplayerGameManager.instance.SpawnPlayer(_id, _username, _position, _rotation);
    }
    ...
    public static void PlayerPosition(Packet _packet)
    {
        ...
        MultiplayerGameManager.players[_id].transform.position = _position;
    }
    ...
    public static void PlayerDisconnected(Packet _packet)
    {
        ...
        Destroy(MultiplayerGameManager.players[_id].gameObject);
        MultiplayerGameManager.players.Remove(_id);
    }
