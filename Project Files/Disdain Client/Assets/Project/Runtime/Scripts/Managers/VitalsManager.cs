...
/// <summary>
/// Deals with vitals for singleplayer & multiplayer
/// </summary>
public class VitalsManager : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        {
            DataManager.SaveGameCallback += SaveVitals;
            DataManager.SaveFileReceiveCallback += LoadVitals;
    ...
    /// <summary>
    /// Modifies specified vitals
    /// </summary>
    /// <param name="vital">The vital id; health = 0, hunger = 1</param>
    /// <param name="change">The amount </param>
    ...
    public void LoadVitals() { for (int i = 0; i < DataManager.SaveFile.Vitals.Count; i++) { vitals[i].amount = DataManager.SaveFile.Vitals[i]; ModifyVitalAmount(i, 0); } }
    public void SaveVitals() { DataManager.SaveFile.Vitals.Clear(); for (int i = 0; i < vitals.Length; i++) { DataManager.SaveFile.Vitals.Add(vitals[i].amount); } }
