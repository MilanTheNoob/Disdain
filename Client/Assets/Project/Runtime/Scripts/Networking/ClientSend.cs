...
public class ClientSend
{
    ...
    public static void OnConnect() { DataManager.tcp.SendData(new Packet((int)ClientPackets.OnConnect)); }
    ...
    {
        Packet packet = new Packet((int)ClientPackets.Login);
    ...
    {
        Packet packet = new Packet((int)ClientPackets.LauncherData);
